...
public class PatientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (preferences.getInt(getString(R.string.preferencesUserType), 1)!=2){
    ...
    private class AsyncTable extends AsyncTask<String, String , String> {
        ...
        protected void onPostExecute(String result){
            ...
            try {
                ...
                Toast.makeText(PatientActivity.this, "Oops!! An error occurred while fetching data.", Toast.LENGTH_LONG).show();
            }
        }
    }
